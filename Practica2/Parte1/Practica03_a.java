...
public class Practica03_a extends javax.swing.JFrame {
    ...
    private javax.swing.JTable TareaProductos;
    ...
    private void initComponents() {
        ...
        Panel.add(Bsalir, gridBagConstraints);

        Beliminar.setText("Eliminar");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        Panel.add(Beliminar, gridBagConstraints);
        ...
        Panel.add(Tinsumo, gridBagConstraints);
        ...
        Panel.add(Tid, gridBagConstraints);
        ...
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        Panel.add(Limagen, gridBagConstraints);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Practica03_a.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
